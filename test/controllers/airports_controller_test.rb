...
class AirportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post airports_url, params: { airport: { coordinates: @airport.coordinates, description: @airport.description, fir: @airport.fir, icao: @airport.icao, name: @airport.name, scenery: @airport.scenery } }
    end
  ...
  test "should update airport" do
    patch airport_url(@airport), params: { airport: { coordinates: @airport.coordinates, description: @airport.description, fir: @airport.fir, icao: @airport.icao, name: @airport.name, scenery: @airport.scenery } }
