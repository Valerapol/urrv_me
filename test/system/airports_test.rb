...
class AirportsTest < ApplicationSystemTestCase
  ...
  test "creating a Airport" do
    ...
    fill_in "Coordinates", with: @airport.coordinates
    fill_in "Description", with: @airport.description
    fill_in "Fir", with: @airport.fir
    fill_in "Icao", with: @airport.icao
    fill_in "Name", with: @airport.name
    fill_in "Scenery", with: @airport.scenery
